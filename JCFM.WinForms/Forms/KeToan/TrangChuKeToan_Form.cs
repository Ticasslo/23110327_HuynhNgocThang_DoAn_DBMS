...
{
    public partial class TrangChuKeToan_Form : Form
    {
        private readonly AppSession _session;

        public TrangChuKeToan_Form(AppSession session)
        {
            InitializeComponent();
        ...
        private void TrangChuKeToan_Form_Load(object sender, EventArgs e)
        {
        ...
        private void btnXemTaiKhoanNH_Click(object sender, EventArgs e)
            => OpenChild(new QLTaiKhoanNH_Form(_session));   // readonly theo role
